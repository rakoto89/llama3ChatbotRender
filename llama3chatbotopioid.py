...
def get_llama3_response(question, user_lang="en"):
    ...
    Only cite real from context. Do not invent sources. Do not stop citations early. Complete the entire reference including titles and URLs. If a citation is long, wrap it across lines using line breaks or bullet points."""
