...
def is_question_relevant(question):
    ...
    if conversation_context.get("last_topic"):
        prev_topic = conversation_context["last_topic"]
        if any(trigger in question_lower for trigger in ["what else", "this year", "who", "what about", "how about"]):
            if prev_topic in relevant_topics:
                return True
    return False
